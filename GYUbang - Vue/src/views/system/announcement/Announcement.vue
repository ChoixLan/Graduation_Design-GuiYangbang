<template>
    <div>
            ...
            <el-table :data="tableList" stripe>
                ...
                <el-table-column fixed="right" label="操作" width="150">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" @click="info(scope.row)" size="small" icon="el-icon-s-order" circle/>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
        ...
        <!--查看公告详情-->
        <el-dialog title="公告详情" :visible.sync="infoOpen" width="80%" @close="dialogClose">
            <div>
                    ...
                    <el-row>
                        ...
                        <el-col :span="7">
                            <el-form-item label="楼栋:">
                                <el-input v-model="form.buildingNum" :disabled="true"/>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-form-item label="内容:">
                        <el-input type="textarea" :rows="10" v-model="form.content" :disabled="true"/>
                    </el-form-item>
                </el-form>
            </div>
        </el-dialog>
